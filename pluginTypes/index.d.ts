...
declare module "@openswap/troll-nft-sdk/contracts/Authorization.json.ts" {
    const _default: {
        abi: ({
            inputs: any[];
...
/// <amd-module name="@openswap/troll-nft-sdk/contracts/Authorization.ts" />
declare module "@openswap/troll-nft-sdk/contracts/Authorization.ts" {
...
declare module "@openswap/troll-nft-sdk/contracts/TrollNFT.json.ts" {
    const _default_1: {
        abi: ({
            inputs: {
                internalType: string;
...
/// <amd-module name="@openswap/troll-nft-sdk/contracts/TrollNFT.ts" />
declare module "@openswap/troll-nft-sdk/contracts/TrollNFT.ts" {
...
declare module "@openswap/troll-nft-sdk/contracts/TrollNFTV2.json.ts" {
    const _default_2: {
        abi: ({
            inputs: ({
                internalType: string;
...
/// <amd-module name="@openswap/troll-nft-sdk/contracts/TrollNFTV2.ts" />
declare module "@openswap/troll-nft-sdk/contracts/TrollNFTV2.ts" {
    import { IWallet, Contract as _Contract, TransactionReceipt, BigNumber, Event, TransactionOptions } from "@ijstech/eth-contract";
    export interface IDeployParams {
        name: string;
        symbol: string;
...
declare module "@openswap/troll-nft-sdk/contracts/TrollNFT_VRF.json.ts" {
    const _default_3: {
        abi: ({
            inputs: {
                internalType: string;
...
/// <amd-module name="@openswap/troll-nft-sdk/contracts/TrollNFT_VRF.ts" />
declare module "@openswap/troll-nft-sdk/contracts/TrollNFT_VRF.ts" {
    import { IWallet, Contract as _Contract, TransactionReceipt, BigNumber, Event, TransactionOptions } from "@ijstech/eth-contract";
    export interface IDeployParams {
        name: string;
        symbol: string;
...
declare module "@openswap/troll-nft-sdk/contracts/TrollNFT_VRFV2.json.ts" {
    const _default_4: {
        abi: ({
            inputs: ({
                internalType: string;
...
/// <amd-module name="@openswap/troll-nft-sdk/contracts/TrollNFT_VRFV2.ts" />
declare module "@openswap/troll-nft-sdk/contracts/TrollNFT_VRFV2.ts" {
    import { IWallet, Contract as _Contract, TransactionReceipt, BigNumber, Event, TransactionOptions } from "@ijstech/eth-contract";
    export interface IDeployParams {
        name: string;
        symbol: string;
...
/// <amd-module name="@openswap/troll-nft-sdk/contracts/index.ts" />
declare module "@openswap/troll-nft-sdk/contracts/index.ts" {
    export { Authorization } from "@openswap/troll-nft-sdk/contracts/Authorization.ts";
    export { TrollNFT } from "@openswap/troll-nft-sdk/contracts/TrollNFT.ts";
    export { TrollNFTV2 } from "@openswap/troll-nft-sdk/contracts/TrollNFTV2.ts";
    export { TrollNFT_VRF } from "@openswap/troll-nft-sdk/contracts/TrollNFT_VRF.ts";
    export { TrollNFT_VRFV2 } from "@openswap/troll-nft-sdk/contracts/TrollNFT_VRFV2.ts";
}
/// <amd-module name="@openswap/troll-nft-sdk" />
declare module "@openswap/troll-nft-sdk" {
    export * as Contracts from "@openswap/troll-nft-sdk/contracts/index.ts";
}
